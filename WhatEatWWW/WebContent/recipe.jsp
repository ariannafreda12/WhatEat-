...
<body class="u-body">
    <header class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-clearfix u-custom-color-4 u-header u-sticky u-header" id="sec-dfab">
    ...
    <br><br>    
        ...
        <table width="500">
        <h3 align="center" class="u-align-center u-custom-font u-font-montserrat u-text u-text-6" style="font-weight:bold"><%out.println(rb.getTitle());%></h2>
        <h6 align="center" class="u-align-center u-custom-font u-font-montserrat u-text u-text-6"><i><b>Category:</b></i>&nbsp;&nbsp;<%out.println(rb.getCategory());%></h6>
        <h6 align="center" class="u-align-center u-custom-font u-font-montserrat u-text u-text-6"><i><b>Difficulty:</b></i>&nbsp;&nbsp;<%out.println(rb.getDifficulty());%></h6>
        <h6 align="center" class="u-align-center u-custom-font u-font-montserrat u-text u-text-6"><i><b>Time:</b></i>&nbsp;&nbsp;<%out.println(rb.getTime());%></h6>
        <h6 align="center" class="u-align-center u-custom-font u-font-montserrat u-text u-text-6"><i><b>Ingredients:</b></i>&nbsp;&nbsp;<br><%out.println(rb.getNecessary());%></h6>
        <h6 align="center" class="u-align-center u-custom-font u-font-montserrat u-text u-text-6"><i><b>Preparation:</b></i>&nbsp;&nbsp;<br><%out.println(rb.getPreparation());%></h6>      
        </table></div></div>   
        <br> 
        <%
        if(ub.getUsername()!="Chef" &&  upm.chooseUserRecipe(rb.getTitle())==null){
