...
public class Recipe {
	...
	public Recipe (String title, String preparation, String time) {
		this.title=title;
		this.preparation = preparation; 
		this.time = time;
	}
	
	public Recipe(int id_recipe, String title, String preparation, String difficulty, String category,  String time, String necessary) {
