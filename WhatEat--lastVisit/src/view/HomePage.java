...
public class HomePage {
	...
	public void start() throws Exception {
        ...
        recLabel.setTextFill(Color.BLACK);
        recLabel.setLayoutX(425);
        recLabel.setLayoutY(79);
        ...
        necLabel.setPrefSize(335, 100);
        necLabel.setEditable(false);
        
        TextArea prepLabel = new TextArea();
        prepLabel.setPrefSize(335, 160);
        ...
        scroll2.setLayoutX(420);
        scroll2.setLayoutY(125);
        scroll2.setPannable(true);
        scroll2.setPrefSize(350, 390);
        ...
        tf.setWrapText(true);
        tf.setFont(Font.font("System", FontPosture.ITALIC, 15));
        tf.setPrefSize(200, 10);
        tf.setPromptText("Insert your city");
        
        Label search= new Label();
        search.setFont(Font.font("System", FontWeight.BOLD, FontPosture.ITALIC, 14));
        search.setText(" Search a cooking class near you");
                      
        Button se= new Button();
        se.setText("Search");
        se.setFont(Font.font("System", FontWeight.BOLD, FontPosture.ITALIC, 12));
        se.setPrefSize(100,20);
        ...
        vbo.getChildren().addAll(search, tf, se);
        vbo.setSpacing(5); 
        
        ScrollPane scroll3 = new ScrollPane(vbo);
        scroll3.setLayoutX(79);
        scroll3.setLayoutY(395);
        scroll3.setPannable(true);
        scroll3.setPrefSize(300, 90);
        scroll3.setVbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
        scroll3.setHbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
        
        root.getChildren().addAll(scroll,scroll2,scroll3);
