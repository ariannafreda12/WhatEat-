...
import logic.controller.GraphicController;
import logic.controller.LoginManager;
import logic.controller.RecipeManager;
...
public class FoundRecipes {
	...
	public void goHomeFr(MouseEvent me)  {
	...
	public void startFoundRec(){
		...
		try {
	        ...
	        TableColumn<Recipe,String> column2 = new TableColumn<> ("Necessary");
	        column2.setCellValueFactory(new PropertyValueFactory<>("necessary"));      
			...
			//cycle for found recipes
				...
				for(Recipe s : secondList) {
					...
					list.add(new Recipe (s.getTitle(), s.getNecessary(), s.getTime(),s.getReview())); 
